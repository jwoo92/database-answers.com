...
<html>
<head>
	<title>DatabaseAnswers.org Performance</title>
</head>
...
<table border=0 cellpadding=0 cellspacing=0 width=100%>
	...
	<table border=0 cellpadding=0 cellspacing=0 width=100%>
		<tr>
		<td align=right><font face="Verdana, Tahoma, sans-serif" size=2 color="blue"><b>Performance</b>&nbsp;&nbsp;</font></td>
